...
secondpage = PageTemplate(
    id="secondpageTwoCol", frames=[frame1_laterpage, frame2_later], onPage=draw_line
)
...
# ===== BUILD CONTENT =====
content = []
# 👉 switch to second template AFTER first page
content.append(NextPageTemplate("secondpageTwoCol"))
